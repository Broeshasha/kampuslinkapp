...
class Speciality {
  ...
  final int maxYear;
  const Speciality(this.id, this.name, {this.yearSystem = 'lmd', this.maxYear = 5});
}
...
const algeriaSpecialities = [
  ...
  Speciality(6, 'Medicine', yearSystem: 'unified', maxYear: 6),
  Speciality(7, 'Pharmacy', yearSystem: 'unified', maxYear: 5),
  Speciality(8, 'Dentistry', yearSystem: 'unified', maxYear: 5),
  Speciality(9, 'Nursing / Paramedical', yearSystem: 'unified', maxYear: 3),
  Speciality(10, 'Law'),
