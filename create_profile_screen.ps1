$folder = "C:\kampuslink\lib\features\profile"
...
Set-Content -Path "$folder\user_profile_screen.dart" -Value $content -NoNewline
Write-Host "user_profile_screen.dart created."