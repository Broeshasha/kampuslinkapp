...
# --- 2. toggle UI, right after the "Add a photo" button, before the submit button ---
$old2 = @"
                ),
...
# --- 3. include the flag + conditional expiry override in the insert ---
$old3 = @"
                              await `$supabase
...
"@.Replace("``$supabase", "_supabase").Replace("`r`n", "`n")
